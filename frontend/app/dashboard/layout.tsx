...
import { BarChart3, Thermometer, Map, AlertTriangle, Menu, Bell, User, Home, X, Droplet, FishSymbol , Sun} from "lucide-react"
...
const navigation = [
  ...
  { name: "Heat Wave Simulation", href: "/dashboard/heat", icon: Sun }
]
